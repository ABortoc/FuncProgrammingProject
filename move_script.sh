...
eval "mv -i _build/default/bin/createread.exe executables/"
eval "mv -i _build/default/bin/removeread.exe executables/"
eval "mv -i _build/default/bin/dropread.exe executables/"
...
eval "mv -i _build/default/bin/createtoread.exe executables/"
eval "mv -i _build/default/bin/removetoread.exe executables/"
eval "mv -i _build/default/bin/droptoread.exe executables/"